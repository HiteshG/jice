...
├── segment-anything-2-real-time/    # Auto-cloned
│   ├── checkpoints/
...
└── vitpose/                         # Auto-downloaded
    └── vitpose-h.pth
```

### Models You Must Upload Manually

| Model | Local Path | Colab Upload Path |
|-------|------------|-------------------|
| `hockey_yolo.pt` | Your machine | `/content/cv/unified_pipeline/models/hockey_yolo.pt` |
| `parseq_hockey.ckpt` | Your machine | `/content/cv/unified_pipeline/models/parseq/parseq_hockey.ckpt` |
| `legibility_resnet34_hockey.pth` | Your machine | `/content/cv/unified_pipeline/models/legibility/legibility_resnet34_hockey.pth` |
...
| ViTPose | `https://download.openmmlab.com/mmpose/...` | `/content/vitpose/` |
